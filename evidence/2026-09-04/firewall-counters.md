...
1 245 18690 ACCEPT all -- * * [source-redacted] [destination-redacted] ctstate RELATED,ESTABLISHED
2 185 12850 ACCEPT udp -- * * [source-redacted] [destination-redacted] udp dpt:53
...
5 0 0 LOG all -- * * [source-redacted] [destination-redacted] limit: avg 6/min burst 10 LOG flags 0 level 6 prefix "ASUS-EDGE-DROP "
6 0 0 DROP all -- * * [source-redacted] [destination-redacted]
```
...
num   pkts bytes target     prot opt in     out     source               destination
1 591 761K ACCEPT all -- * * [source-redacted] [destination-redacted] ctstate RELATED,ESTABLISHED
...
4 1 60 ACCEPT tcp -- tailscale0 br0 [source-redacted] [destination-redacted] tcp dpt:9100 ctstate NEW
...
num   pkts bytes target     prot opt in     out     source               destination
1 185 12850 REDIRECT udp -- * * [source-redacted] [destination-redacted] udp dpt:53 redir ports 53
