...
1 1000 55229 ACCEPT all -- * * [source-redacted] [destination-redacted] ctstate RELATED,ESTABLISHED
2 1476 97417 ACCEPT udp -- * * [source-redacted] [destination-redacted] udp dpt:53
3 9 520 ACCEPT tcp -- * * [source-redacted] [destination-redacted] tcp dpt:53
4 0 0 ACCEPT tcp -- * * [source-redacted] [destination-redacted] tcp dpt:8443 ctstate NEW
5 48 3048 LOG all -- * * [source-redacted] [destination-redacted] limit: avg 6/min burst 10 LOG flags 0 level 6 prefix "ASUS-EDGE-DROP "
6 109 6732 DROP all -- * * [source-redacted] [destination-redacted]
```
...
num   pkts bytes target     prot opt in     out     source               destination
1 181K 76M ACCEPT all -- * * [source-redacted] [destination-redacted] ctstate RELATED,ESTABLISHED
...
6 3670 1991K ACCEPT all -- * ppp0 [source-redacted] [destination-redacted]
7 48 87264 LOG all -- * * [source-redacted] [destination-redacted] limit: avg 6/min burst 10 LOG flags 0 level 6 prefix "ASUS-EDGE-DROP "
8 78 142K DROP all -- * * [source-redacted] [destination-redacted]
```
...
num   pkts bytes target     prot opt in     out     source               destination
1 1476 97417 REDIRECT udp -- * * [source-redacted] [destination-redacted] udp dpt:53 redir ports 53
2 8 480 REDIRECT tcp -- * * [source-redacted] [destination-redacted] tcp dpt:53 redir ports 53
