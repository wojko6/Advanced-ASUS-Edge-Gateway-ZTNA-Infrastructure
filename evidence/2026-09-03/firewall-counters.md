...
1 308 24721 ACCEPT all -- * * [source-redacted] [destination-redacted] ctstate RELATED,ESTABLISHED
2 0 0 ACCEPT udp -- * * [source-redacted] [destination-redacted] udp dpt:53
...
5 2 104 LOG all -- * * [source-redacted] [destination-redacted] limit: avg 6/min burst 10 LOG flags 0 level 6 prefix "ASUS-EDGE-DROP "
6 2 104 DROP all -- * * [source-redacted] [destination-redacted]
```
...
2 0 0 ACCEPT all -- * ppp0 [source-redacted] [destination-redacted]
3 0 0 LOG all -- * * [source-redacted] [destination-redacted] limit: avg 6/min burst 10 LOG flags 0 level 6 prefix "ASUS-EDGE-DROP "
4 0 0 DROP all -- * * [source-redacted] [destination-redacted]
```
...
num   pkts bytes target     prot opt in     out     source               destination
1 0 0 REDIRECT udp -- * * [source-redacted] [destination-redacted] udp dpt:53 redir ports 53
