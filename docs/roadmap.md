...
- Repository follow-up: implement the tested control as opt-in `EDGE_BLOCK_LAN_DOT`, with a dedicated managed filter chain, health-check ordering/policy validation, regression coverage, and rollback-by-disable semantics.
